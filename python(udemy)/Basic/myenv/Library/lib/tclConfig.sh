...
# installed.
TCL_PREFIX='D:/Aditya/Downloads_D/Data_Science/python(udemy)/Basic/myenv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Aditya/Downloads_D/Data_Science/python(udemy)/Basic/myenv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Aditya/Downloads_D/Data_Science/python(udemy)/Basic/myenv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Aditya/Downloads_D/Data_Science/python(udemy)/Basic/myenv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Aditya/Downloads_D/Data_Science/python(udemy)/Basic/myenv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/Aditya/Downloads_D/Data_Science/python(udemy)/Basic/myenv\Library\lib\tclstub86.lib'
